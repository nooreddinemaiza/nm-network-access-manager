...
use App\Models\Statistics\Statistic as StatisticsService;
...
class StatisticController extends Controller
{
     ...
     * @return array
     */
    public function getUserSummary(string|int $user): array
    {
        $sql = "SELECT 
        ...
        $result = $this->db->query($sql, ['user' => $this->resolveUsername($user)]);
