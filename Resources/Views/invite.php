...
<div x-data="pageData()" class="min-h-screen mx-auto bg-gray-50 dark:bg-gray-900">
    <!-- Contenu principal -->
    ...
    <div
        ...
        class="mb-6 sm:mb-8">
        <div class="max-w-2xl mx-auto rounded-lg p-3 text-white ">
            ...
            <div
                    ...
                    <form @submit.prevent="submitForm" class="space-y-5">
                        ...
                        <button
                            ...
                            <span x-show="!loading" class="flex items-center space-x-2">
                                ...
                                <span>Rejoindre <span class="font-bold "><?= htmlspecialchars($invite['group']) ?></span></span>
                ...
                <div class="mt-6 grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm text-black dark:text-white">
                    ...
                    <div class="bg-white/20 rounded-lg px-3 py-2.5 flex items-center space-x-2 border border-red-300">
                        <svg class="w-4 h-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                        </svg>
                        <span class="font-medium text-xs sm:text-sm " id="remaining"><?= $remaining ?></span>
                    </div>
                </div>
            </div>
        </div>
